...
from nnunetv2.Network.SwinUNETR import SwinUNETR
...
class nnUNetTrainerSwinUNETR(nnUNetTrainerNoDeepSupervision):
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        model = SwinUNETR(img_size=(16, 256, 256), in_channels=num_input_channels, out_channels=label_manager.num_segmentation_heads,feature_size=48).cuda()
