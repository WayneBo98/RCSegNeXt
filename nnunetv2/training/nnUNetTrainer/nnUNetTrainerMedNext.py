...
class nnUNetTrainerMedNext(nnUNetTrainerNoDeepSupervision):
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        model = create_mednext_v1(num_input_channels=num_input_channels, num_classes=label_manager.num_segmentation_heads, model_id='B', kernel_size=3,deep_supervision=False).cuda()
