...
from nnunetv2.Network.neural_network import SegmentationNetwork
    ...
    def __init__(self,
        ...
        for i_layer in range(self.num_layers):
            layer = BasicLayer(
                ...
                input_resolution=(
                    pretrain_img_size[0]  // 2 ** i_layer, pretrain_img_size[1] // patch_size[1] // 2 ** i_layer,
    ...
    def __init__(self,
        ...
        for i_layer in range(self.num_layers)[::-1]:
            ...
            layer = BasicLayer_up(
                ...
                input_resolution=(
                    pretrain_img_size[0]  // 2 ** (len(depths)-i_layer-1), pretrain_img_size[1] // patch_size[1] // 2 ** (len(depths)-i_layer-1),
...
class final_patch_expanding(nn.Module):
    def __init__(self,dim,num_class,patch_size):
        super().__init__()
        self.up=nn.ConvTranspose3d(dim,num_class,[1,4,4],[1,4,4])
